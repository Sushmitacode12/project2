function saveToLocalStorage(event) {
    ...
    axios.post("https://crudcrud.com/api/58e9f6fdd25c48a7a270047afd605bbb/expenseData",obj)
      .then((Response)=>{
...
window.addEventListener('DOMContentLoaded', () => {
  axios.get("https://crudcrud.com/api/58e9f6fdd25c48a7a270047afd605bbb/expenseData")
    .then((Response)=>{
      console.log(Response)
...
function deleteExpenses(userId){
  axios.delete(`https://crudcrud.com/api/58e9f6fdd25c48a7a270047afd605bbb/expenseData/${userId}`)
  .then((Response)=>{
